...
| [GunGameCursedRandom](GunGameCursedRandom/DEV_STATUS.md) | Active `1.0.0`; selectable-profile candidate deployed to Default profile, VR smoke test pending | [design](GunGameCursedRandom/DESIGN.md), [development status](GunGameCursedRandom/DEV_STATUS.md) |
