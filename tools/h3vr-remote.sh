...
shift
case "$action" in
  Preflight|SourceStatus|RefreshSource|FindType|FindMethod|GrepSource|PrepareUnitySourceSync|SyncUnitySource|AuditItemId|AuditUnityDeployment|AuditManagedDeployment|InventoryProfilePackages|RemoveProfilePackage|AssetRipStatus|FindAssetRip|InspectAssetRip|UnityAssetRipStatus|UnityVanillaImportSmokeTest|UnityVanillaPrefabSmokeTest|UnityVanillaPrefabCompareNightForce|UnityVanillaPrefabAuditNightForce|UnityVanillaRuntimeCandidatePrepare|UnityVanillaRuntimeCandidateStatus|UnityVanillaPrefabImportStatus|UnityVanillaImportStatus|QuarantineVanillaScopeImports|UnityNightForcePrefabStatus|UnityBuildStatus|Verify|Build|Test|Package|Deploy|ShutdownWindows|Logs|TailLogs|ClearLogs|SetPublishToken|Publish)
    ;;
  *)
