...
namespace RemoveWhiteOut
{
    ...
    [BepInPlugin("HLin-RemoveWhiteOut", PluginInfo.PLUGIN_NAME, "1.0.0")]
    public class Plugin : BaseUnityPlugin
    {
        public void Awake()
        {
            Harmony harmony = new Harmony(PluginInfo.PLUGIN_GUID);
            MethodInfo original = AccessTools.Method(typeof(WW_TeleportMaster), "UpdateWhiteOut");
            MethodInfo patch = AccessTools.Method(typeof(Plugin), "UpdateWhiteOut_MyPatch");
