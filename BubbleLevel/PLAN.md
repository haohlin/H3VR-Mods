...
| `[x]` | Keep `2.0.3` handoff ready. | `DESIGN.md`, `STATUS.md`, `PLAN.md`, and `TESTING.md` state current release, source-only documentation boundary, verified behavior, and first resume action. |
