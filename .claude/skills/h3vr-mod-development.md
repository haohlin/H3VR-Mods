...
The Windows checkout at `%H3VR_WINDOWS_REPOSITORY%` is authoritative for H3VR builds,
deployment, VR testing, and Thunderstore releases. The macOS checkout is a Git
mirror for review and synchronized source edits.
