...
namespace Teleport
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static bool FindValidPointCurved_MyPatch(FVRMovementManager __instance, ref Vector3 __result, Vector3 castOrigin, Vector3 castDir, float initialVel)
        {
            ...
            if (Physics.Raycast(castOrigin, vector, out __instance.m_hit_ray, max_dist, __instance.LM_TeleCast) && !__instance.m_hit_ray.transform.gameObject.CompareTag("NoTeleport"))
            {
